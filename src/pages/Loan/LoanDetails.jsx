...
import { useLoan } from '../../hooks/useLoanQueries';
import { 
  ArrowLeft,
  DollarSign,
  Calendar,
...
const LoanDetails = () => {
  ...
  const { data: loanData, isLoading } = useLoan(id ? id : null);
  ...
  // Payment/Repayment features removed as requested
  ...
  const calculateMonthlyPayment = () => {
    const principal = (loan.totalAmount ?? loan.amount ?? 0);
  ...
  const totalInterest = (monthlyPayment * (loan.duration || 0)) - (loan.totalAmount ?? loan.amount ?? 0);
  ...
  return (
    <div className={`min-h-screen p-4 lg:p-8 transition-colors duration-300 ${
          ...
          <div className={`p-6 border-b ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button onClick={() => navigate(`/loan/edit/${id}`)} className="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <div className="space-y-4">
                  ...
                  {loan.commencementDate && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Loan Start Date</p>
                        <p className="font-medium text-gray-900 dark:text-white">
                  ...
                  {loan.completionDate && (
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-gray-400" />
                      <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Loan End Date</p>
                        <p className="font-medium text-gray-900 dark:text-white">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className={`p-4 rounded-xl border ${
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Due</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 mb-2">
                <div 
                  ...
                  style={{ 
                    width: `${(loan.totalAmount ? ((loan.paidAmount ?? 0) / loan.totalAmount) * 100 : 0)}%` 
                  }}
                ></div>
              </div>
              ...
              <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                ...
                <span>Due: {formatCurrency(loan.totalDue ?? 0)}</span>
              </div>
            </div>
      ...
      {/* Payment modal removed as requested */}
    </div>
  );
};
