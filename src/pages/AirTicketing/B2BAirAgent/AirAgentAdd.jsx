...
import { useCreateAirAgent } from '../../../hooks/useB2BAirAgentQueries';

const AirAgentAdd = () => {
  const navigate = useNavigate();
  const createMutation = useCreateAirAgent();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to agent list after successful save
      setTimeout(() => {
        navigate('/air-ticketing/agent');
      }, 1000);
