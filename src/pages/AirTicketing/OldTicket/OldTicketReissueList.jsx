...
const OldTicketReissueList = () => {
  ...
  const { useOldTicketReissues, useDeleteOldTicketReissue } = useOldTicketReissueQueries();
  const { data, isLoading, refetch } = useOldTicketReissues({
    page,
    limit,
    q: searchTerm
  });

  const deleteMutation = useDeleteOldTicketReissue();

  // Get data from API
  const reissues = data?.reissues || [];
  ...
  return (
    <>
      <Helmet>
        <title>পুরাতন টিকেট রিইস্যু - Bin Rashid ERP</title>
      </Helmet>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button 
            onClick={() => navigate('/air-ticketing/old/ticket-reissue/new')}
                      ...
                      <tr key={reissue._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <button 
                              onClick={() => navigate(`/air-ticketing/old/ticket-reissue/${reissue._id}`)}
