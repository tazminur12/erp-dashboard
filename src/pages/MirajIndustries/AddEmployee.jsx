            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                {imagePreview || formData.image ? (
                  <div className="relative">
                    <label className="cursor-pointer">
                      <img
                        ...
                        alt="Preview"
                        className="w-24 h-24 rounded-full object-cover border-2 border-blue-200 hover:opacity-80 transition-opacity"
                      />
                      <input
                        type="file"
                        accept="image/*"
                  ...
                  <label className="cursor-pointer">
                    <div className="w-24 h-24 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center hover:border-blue-500 transition-colors">
                      {uploadingImage ? (
              ...
              <div className="flex-1">
                ...
                {!imagePreview && !formData.image && (
                  <label className="mt-2 inline-flex items-center gap-2 px-3 py-1.5 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                ...
                {imagePreview || formData.image ? (
                  <label className="mt-2 inline-flex items-center gap-2 px-3 py-1.5 text-sm border border-blue-300 rounded-lg hover:bg-blue-50 cursor-pointer text-blue-600">
                    <Camera className="w-4 h-4" />
                    ছবি পরিবর্তন করুন
                    <input
                      type="file"
