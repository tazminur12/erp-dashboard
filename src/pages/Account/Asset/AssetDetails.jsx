...
const AssetDetails = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Helmet>
        <title>{asset.name} - সম্পদ বিবরণ</title>
        <meta name="description" content={`${asset.name} এর সম্পূর্ণ বিবরণ`} />
      </Helmet>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">সম্পদের সম্পূর্ণ বিবরণ</p>
          </div>
        </div>

        <button
          onClick={() => navigate(`/account/asset-management/${id}/edit`)}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            ...
            {asset.providerCompanyName && (
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">প্রোভাইডার কোম্পানি</p>
