...
const AddAsset = () => {
  ...
  const { useCreateAsset } = useAssetQueries();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error?.response?.data?.message || error?.message || 'সম্পদ যোগ করতে সমস্যা হয়েছে';
      Swal.fire({
        title: 'ত্রুটি!',
        text: errorMessage,
        icon: 'error',
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Helmet>
        ...
        <meta name="description" content="নতুন সম্পদ যোগ করুন" />
      </Helmet>
