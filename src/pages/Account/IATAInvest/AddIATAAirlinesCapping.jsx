...
import { useCreateIATAAirlinesCappingInvestment } from '../../../hooks/useInvestmentQueries';
import Swal from 'sweetalert2';

const AddIATAAirlinesCapping = () => {
  ...
  const createInvestmentMutation = useCreateIATAAirlinesCappingInvestment();
  ...
  const validateForm = () => {
    ...
    if (!formData.airlineName.trim()) {
      newErrors.airlineName = 'এয়ারলাইন নাম আবশ্যক';
    }

    if (!formData.cappingAmount || parseFloat(formData.cappingAmount) <= 0) {
      newErrors.cappingAmount = 'বিনিয়োগ পরিমাণ আবশ্যক এবং ০ এর চেয়ে বেশি হতে হবে';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createInvestmentMutation.mutateAsync(formData);
      ...
      Swal.fire({
        title: 'ত্রুটি!',
        text: error.message || 'বিনিয়োগ যোগ করতে সমস্যা হয়েছে',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#EF4444',
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <Helmet>
        <title>নতুন IATA & Airlines Capping বিনিয়োগ যোগ করুন</title>
        <meta name="description" content="Add new IATA & Airlines Capping investment" />
      </Helmet>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                ...
                নতুন IATA & Airlines Capping বিনিয়োগ যোগ করুন
              </h1>
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                নতুন IATA বা Airlines Capping বিনিয়োগ যোগ করুন
              </p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-6">
                <div className="flex-shrink-0 relative">
                  {formData.logo || uploadedImageUrl ? (
                    ...
                    <div className="w-24 h-24 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 flex items-center justify-center border-2 border-gray-200 dark:border-gray-600">
                      {isUploading ? (
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all ${
            ...
            <div>
              ...
              />
              {errors.airlineName && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.airlineName}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                {errors.cappingAmount && (
                  <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.cappingAmount}</p>
                )}
              </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all"
                required
              >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={4}
                className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all resize-none"
            ...
            <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
...
export default AddIATAAirlinesCapping;
