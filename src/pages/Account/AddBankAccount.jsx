...
import { ArrowLeft, Upload, Image as ImageIcon, Building2, X, Loader2 } from 'lucide-react';
...
const AddBankAccount = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    currency: 'BDT',
    contactNumber: '',
    createdBy: '', // User can input normally
    branchId: '' // User can input normally
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: 'সফল!',
        text: 'ব্যাংক অ্যাকাউন্ট সফলভাবে তৈরি হয়েছে!',
        icon: 'success',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#10B981',
        background: isDark ? '#1F2937' : '#F9FAFB',
      ...
      Swal.fire({
        title: 'ত্রুটি!',
        text: 'ব্যাংক অ্যাকাউন্ট তৈরি করতে সমস্যা হয়েছে। আবার চেষ্টা করুন।',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#EF4444',
        background: isDark ? '#1F2937' : '#FEF2F2',
