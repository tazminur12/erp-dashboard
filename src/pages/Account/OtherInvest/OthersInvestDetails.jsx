...
const OthersInvestDetails = () => {
  ...
  const { data: investment, isLoading: investmentLoading, error: investmentError } = useOthersInvestInvestment(id);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <button
                onClick={() => navigate('/account/investments/others-invest')}
  ...
  const expectedReturn = () => {
    ...
    const principal = investment.investmentAmount || 0;
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          ...
          navigate('/account/investments/others-invest');
        });
      } catch (error) {
        Swal.fire({
          title: 'ত্রুটি!',
  ...
  const profit = expectedReturnAmount - (investment.investmentAmount || 0);
  const profitPercentage = investment.investmentAmount ? ((profit / investment.investmentAmount) * 100).toFixed(2) : 0;

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <Helmet>
        <title>Others Invest Details - {investment.investmentName}</title>
        <meta name="description" content={`Details for ${investment.investmentName} investment`} />
      </Helmet>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div className="flex items-center space-x-4">
            ...
            {investment.logo ? (
              ...
              <div className="w-16 h-16 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 flex items-center justify-center shadow-md">
          ...
          <div className="flex items-center space-x-2 mt-4 sm:mt-0">
            <button
              onClick={handleEdit}
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50"
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl shadow-lg p-6 border-2 border-blue-200 dark:border-blue-800">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-xs mt-1 ${profit >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                  ({profitPercentage}%)
                </p>
              </div>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="w-32 h-32 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-3 flex items-center justify-center shadow-md">
                      <img 
                        src={investment.logo} 
                        alt={investment.investmentName || 'Investment Logo'} 
                        className="w-full h-full object-contain"
                        onError={(e) => {
                          e.target.style.display = 'none';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-green-600 dark:text-green-400">
                    ৳{(investment.returnAmount || expectedReturnAmount).toLocaleString('bn-BD')}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-400">মূল বিনিয়োগ:</span>
                  <span className="text-sm font-semibold text-gray-900 dark:text-white">
                    ৳{(investment.investmentAmount || 0).toLocaleString('bn-BD')}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-400">আনুমানিক রিটার্ন:</span>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-900 dark:text-white">মোট লাভ/ক্ষতি:</span>
                    <span className={`text-sm font-bold ${profit >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                      {profit >= 0 ? '+' : ''}৳{profit.toLocaleString('bn-BD')} ({profitPercentage}%)
                    </span>
                  </div>
                </div>
              </div>
...
export default OthersInvestDetails;
