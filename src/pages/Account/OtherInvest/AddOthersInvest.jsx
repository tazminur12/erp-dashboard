...
import { useCreateOthersInvestInvestment } from '../../../hooks/useInvestmentQueries';
import Swal from 'sweetalert2';

const AddOthersInvest = () => {
  ...
  const createInvestmentMutation = useCreateOthersInvestInvestment();
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <Helmet>
        <title>নতুন বিনিয়োগ যোগ করুন</title>
        <meta name="description" content="Add new investment" />
      </Helmet>
...
export default AddOthersInvest;
