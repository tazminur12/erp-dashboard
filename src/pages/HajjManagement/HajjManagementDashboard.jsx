...
const HajjManagementDashboard = () => {
  const [dashboardData, setDashboardData] = useState({
    ...
    // Status Distribution
    statusDistribution: [
      { status: 'registered', count: 25, label: 'নিবন্ধিত', color: 'bg-blue-500' },
      { status: 'confirmed', count: 45, label: 'নিশ্চিত', color: 'bg-green-500' },
      { status: 'visa_issued', count: 32, label: 'ভিসা জারি', color: 'bg-purple-500' },
      { status: 'departed', count: 28, label: 'যাত্রা করেছেন', color: 'bg-orange-500' },
      { status: 'returned', count: 18, label: 'ফিরে এসেছেন', color: 'bg-gray-500' },
      { status: 'cancelled', count: 8, label: 'বাতিল', color: 'bg-red-500' }
    ],

    // Hajj Type Distribution
    hajjTypeDistribution: [
      { type: 'হজ্জ', count: 89, percentage: 57, color: 'bg-purple-600' },
      { type: 'উমরাহ', count: 45, percentage: 29, color: 'bg-blue-600' },
      { type: 'হজ্জ ও উমরাহ', count: 22, percentage: 14, color: 'bg-green-600' }
    ]
  });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
              হজ্জ ব্যবস্থাপনা ড্যাশবোর্ড
            </h1>
            <p className="text-gray-600 dark:text-gray-400">
              হাজী ব্যবস্থাপনা ও পরিসংখ্যান
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
          ...
          >
            ...
            <span className="text-sm">হাজী তালিকা</span>
          </Link>
          <Link
            to="/hajj-management/add"
          ...
          >
            ...
            <span className="text-sm">নতুন হাজী</span>
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">মোট হাজী</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{dashboardData.totalHajjis}</p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">নিশ্চিত বুকিং</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{dashboardData.confirmedBookings}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center text-sm">
            <TrendingUp className="w-4 h-4 text-green-500 mr-1" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">সক্রিয় বুকিং</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{dashboardData.activeBookings}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center text-sm">
            <TrendingUp className="w-4 h-4 text-green-500 mr-1" />
              ...
              <div key={booking.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900/20 rounded-full flex items-center justify-center">
                    {getHajjTypeIcon(booking.hajjType)}
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">{booking.customerName}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{booking.hajjType} - {booking.packageType}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-blue-700 dark:text-blue-300 font-medium">হাজী তালিকা</span>
            </Link>
            ...
            >
              ...
              <span className="text-green-700 dark:text-green-300 font-medium">নতুন হাজী</span>
            </Link>
            
            <Link
              to="/hajj-management/reports"
            ...
            >
              ...
              <span className="text-purple-700 dark:text-purple-300 font-medium">রিপোর্ট</span>
            </Link>
            
            <Link
              to="/hajj-management/analytics"
            ...
            >
              <PieChart className="w-5 h-5 text-orange-600 dark:text-orange-400 mr-3" />
              <span className="text-orange-700 dark:text-orange-300 font-medium">বিশ্লেষণ</span>
            </Link>
          </div>
        </div>
      </div>
          ...
          {dashboardData.statusDistribution.map((item) => (
            <div key={item.status} className="text-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {Math.round((item.count / dashboardData.totalHajjis) * 100)}%
              </p>
            </div>
          ))}
        </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          {pkg.bookings}/{pkg.capacity} হাজী
                        </div>
                      </div>
                    </div>
                  </td>
...
export default HajjManagementDashboard;
