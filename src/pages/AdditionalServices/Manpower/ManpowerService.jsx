...
import { useManpowerServices, useDeleteManpowerService } from '../../../hooks/useManpowerServiceQueries';
...
const ManpowerService = () => {
  ...
  const { data, isLoading, error } = useManpowerServices({
    page,
    limit,
    q: search,
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <Helmet>
        <title>ম্যানপাওয়ার সার্ভিস - অতিরিক্ত সার্ভিস</title>
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ম্যানপাওয়ার সার্ভিস</h1>
              <p className="text-gray-600 mt-2">ম্যানপাওয়ার সার্ভিস এবং নিয়োগ ব্যবস্থাপনা করুন</p>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm">সক্রিয়</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {error ? (
            <div className="p-8 text-center">
              <p className="text-red-600">ম্যানপাওয়ার সার্ভিস লোড করতে সমস্যা হয়েছে</p>
            </div>
          ) : services.length === 0 ? (
            <div className="p-8 text-center">
              <Briefcase className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <p className="text-gray-500 text-lg">কোন ম্যানপাওয়ার সার্ভিস পাওয়া যায়নি</p>
              <button
                onClick={() => navigate('/additional-services/manpower-service/add')}
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-6 py-4 text-left text-sm font-medium text-gray-700">ক্লায়েন্ট/কোম্পানি</th>
                      ...
                      <tr key={service._id || service.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">আইডি: {service.serviceId || service.id || 'N/A'}</p>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4">
                          ...
                          {service.requiredCount && (
                            <p className="text-sm text-gray-500">প্রয়োজন: {service.requiredCount}</p>
                          )}
                        </td>
                        <td className="px-6 py-4">
