...
const AddCustomer = () => {
  ...
  const { useCreateOtherCustomer } = useOtherCustomerQueries();
  const createMutation = useCreateOtherCustomer();
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <Helmet>
        <title>Add Customer - Additional Services</title>
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Fill in the customer information below</p>
        </div>
