...
const UmrahPackageEdit = () => {
  ...
  useEffect(() => {
    if (existingPackage) {
      ...
      setFormData({
        ...
        customPackageType: 'Custom Umrah', // Force to Custom Umrah
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate('/umrah/umrah-package-list')}
            className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
          >
            উমরাহ প্যাকেজ তালিকায় ফিরুন
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
      <Helmet>
        <title>Umrah Package Edit</title>
        <meta name="description" content="Edit Umrah package details." />
      </Helmet>
      <style>{`
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white px-8 py-3 rounded-lg flex items-center space-x-2 transition-all duration-200 disabled:cursor-not-allowed"
                >
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 rounded-xl p-4 border border-purple-200/50 dark:border-purple-700/30 shadow-sm">
                    <h4 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-4 flex items-center">
                      <div className="w-6 h-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-md flex items-center justify-center mr-2">
