...
const HajPackageEdit = () => {
  ...
  useEffect(() => {
    if (existingPackage) {
      ...
      setFormData({
        ...
        arbiYear: existingPackage.arbiYear || '',
        packageCategory: existingPackage.packageCategory || 'A',
        packageType: existingPackage.packageType || 'Fitra',
  ...
  const calculateTotals = () => {
    ...
    const saudiCostsRaw = 
      ...
      (costs.zamzamWater || 0) +
      (costs.maktab || 0) +
      (costs.visaFee || 0) + // ভিসা ফি সৌদি অংশ
