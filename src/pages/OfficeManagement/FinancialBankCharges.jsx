...
const FinancialBankCharges = () => {
  ...
  const subcategories = [
    ...
    },
    {
      ...
      banglaName: 'সুদ প্রদান',
      icon: TrendingUp,
      color: 'from-red-500 to-red-600'
    },
    {
      id: 'loan-processing-fees',
      name: 'Loan Processing Fees',
      banglaName: 'ঋণ প্রক্রিয়াকরণ ফি',
      icon: FileText,
    ...
    },
    {
      ...
      banglaName: 'ক্রেডিট কার্ড ফি',
      icon: CreditCard,
      color: 'from-orange-500 to-orange-600'
    },
    {
      id: 'foreign-exchange-fees',
      name: 'Foreign Exchange Fees',
      banglaName: 'বৈদেশিক মুদ্রা ফি',
      icon: Banknote,
    ...
    },
    {
      ...
      banglaName: 'একাউন্ট রক্ষণাবেক্ষণ ফি',
      icon: Receipt,
      color: 'from-teal-500 to-teal-600'
    },
    {
      id: 'wire-transfer-fees',
      name: 'Wire Transfer Fees',
      banglaName: 'ওয়্যার ট্রান্সফার ফি',
      icon: TrendingDown,
      color: 'from-pink-500 to-pink-600'
    },
    {
      id: 'check-processing-fees',
      name: 'Check Processing Fees',
      banglaName: 'চেক প্রক্রিয়াকরণ ফি',
      icon: Receipt,
  ...
  const [expenses, setExpenses] = useState([
    {
      ...
      vendor: 'Sonali Bank Limited',
      notes: 'Monthly maintenance charge for business account',
      status: 'Completed'
    },
    {
      id: 2,
      ...
      amount: 2500,
      description: 'Online Transfer Fees',
      date: '2024-01-12',
      paymentMethod: 'Auto Debit',
      reference: 'TXN-FEE-002',
      vendor: 'Islami Bank Bangladesh',
      notes: 'Multiple online transfer transactions',
      status: 'Pending'
    },
    {
      id: 3,
      ...
      reference: 'INT-PAY-003',
      vendor: 'Dutch Bangla Bank',
      notes: 'Monthly interest payment for business loan',
      status: 'Completed'
    }
  ]);
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-xs sm:text-sm transition-colors duration-300 ${
                  ...
                  আর্থিক ও ব্যাংক চার্জ ব্যবস্থাপনা
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className={`p-3 sm:p-4 rounded-xl shadow-lg border transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Total Charges</p>
          ...
          <div className={`p-3 sm:p-4 rounded-xl shadow-lg border transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Auto Debit</p>
                <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">
                  {expenses.filter(e => e.paymentMethod === 'Auto Debit').length}
                </p>
              </div>
        ...
        <div className={`p-3 sm:p-4 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search bank charges..."
              value={searchTerm}
          ...
          <div className={`p-4 sm:p-6 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {editItem ? 'Edit Bank Charge' : 'Add New Bank Charge'}
              </h3>
              <button
                onClick={() => {
                  setShowAddForm(false);
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  placeholder="Bank charge description"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                      : 'border-gray-300'
              ...
              <div className="sm:col-span-2 lg:col-span-3">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="3"
                  placeholder="Additional notes about the charge..."
              ...
              <div className="sm:col-span-2 lg:col-span-3 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-medium transition-all duration-200 hover:scale-105 text-sm"
                >
                  <Save className="w-4 h-4 inline mr-2" />
                  {editItem ? 'Update Charge' : 'Add Charge'}
                </button>
              </div>
            </form>
          </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          {categoryExpenses.length} charges
                        </p>
                      </div>
                      {isExpanded ? (
                    ...
                    {categoryExpenses.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                          No bank charges found for this category
                        </p>
                      </div>
                    ) : (
...
export default FinancialBankCharges;
