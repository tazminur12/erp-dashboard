...
const RefundsReimbursements = () => {
  ...
  const subcategories = [
    ...
    },
    {
      ...
      banglaName: 'ভ্রমণ ক্ষতিপূরণ',
      icon: Plane,
      color: 'from-purple-500 to-purple-600'
    },
    {
      id: 'meal-reimbursements',
      name: 'Meal Reimbursements',
      banglaName: 'খাবার ক্ষতিপূরণ',
      icon: Utensils,
      color: 'from-orange-500 to-orange-600'
    },
    {
      id: 'transportation-reimbursements',
      name: 'Transportation Reimbursements',
      banglaName: 'পরিবহন ক্ষতিপূরণ',
      icon: Car,
      color: 'from-indigo-500 to-indigo-600'
    },
    {
      id: 'office-supplies-reimbursements',
      name: 'Office Supplies Reimbursements',
      banglaName: 'অফিস সরবরাহ ক্ষতিপূরণ',
      icon: ShoppingBag,
      color: 'from-pink-500 to-pink-600'
    },
    {
      id: 'communication-reimbursements',
      name: 'Communication Reimbursements',
      banglaName: 'যোগাযোগ ক্ষতিপূরণ',
      icon: Smartphone,
      color: 'from-teal-500 to-teal-600'
    },
    {
      id: 'accommodation-reimbursements',
      name: 'Accommodation Reimbursements',
      banglaName: 'বাসস্থান ক্ষতিপূরণ',
      icon: Hotel,
      color: 'from-cyan-500 to-cyan-600'
    },
    {
      id: 'medical-reimbursements',
      name: 'Medical Reimbursements',
      banglaName: 'চিকিৎসা ক্ষতিপূরণ',
      icon: FileCheck,
      color: 'from-red-500 to-red-600'
    },
    {
      id: 'training-reimbursements',
      name: 'Training Reimbursements',
      banglaName: 'প্রশিক্ষণ ক্ষতিপূরণ',
      icon: FileText,
  ...
  const [expenses, setExpenses] = useState([
    {
      id: 1,
      subcategory: 'customer-refunds',
      amount: 25000,
      description: 'Hajj Package Cancellation Refund',
      date: '2024-01-15',
      paymentMethod: 'Bank Transfer',
      reference: 'REF-2024-001',
      recipient: 'Ahmed Rahman',
      notes: 'Customer cancelled Hajj package due to health issues',
    ...
    {
      id: 2,
      subcategory: 'employee-reimbursements',
      amount: 8500,
      description: 'Office Equipment Purchase Reimbursement',
      date: '2024-01-12',
      paymentMethod: 'Bank Transfer',
      reference: 'REIMB-2024-002',
      recipient: 'Fatima Khatun',
      notes: 'Employee purchased office supplies for work',
    ...
    {
      id: 3,
      subcategory: 'travel-reimbursements',
      amount: 15000,
      description: 'Business Trip Travel Expenses',
      date: '2024-01-10',
      paymentMethod: 'Bank Transfer',
      reference: 'TRAVEL-2024-003',
      recipient: 'Karim Uddin',
      notes: 'Travel expenses for client meeting in Chittagong',
  ...
  const handleSubmit = (e) => {
    ...
    const newExpense = {
      ...
      originalAmount: parseFloat(formData.originalAmount || formData.amount),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-teal-500 to-teal-600 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <p className={`text-xs sm:text-sm transition-colors duration-300 ${
                  ...
                  প্রত্যর্পণ ও ক্ষতিপূরণ ব্যবস্থাপনা
                </p>
              </div>
            </div>
            ...
            >
              ...
              <span className="hidden sm:inline">Add Refund/Reimbursement</span>
        ...
        <div className={`p-3 sm:p-4 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search refunds and reimbursements..."
              value={searchTerm}
          ...
          <div className={`p-4 sm:p-6 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {editItem ? 'Edit Refund/Reimbursement' : 'Add New Refund/Reimbursement'}
              </h3>
              <button
                onClick={() => {
                  setShowAddForm(false);
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Reason for refund/reimbursement"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                      : 'border-gray-300'
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  step="0.01"
                  placeholder="Original amount (if applicable)"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                      : 'border-gray-300'
              ...
              <div className="sm:col-span-2 lg:col-span-3 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white rounded-lg font-medium transition-all duration-200 hover:scale-105 text-sm"
                >
                    ...
                    {categoryExpenses.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                          No refunds/reimbursements found for this category
                        </p>
                      </div>
                    ) : (
                              ...
                              <div className="flex-1">
                                <div className="flex items-start justify-between mb-2">
                                  <div>
                                    ...
                                    <p className="text-xs text-gray-600 dark:text-gray-400">
                                      {expense.reference} • {expense.recipient}
                                    </p>
                                    <p className="text-xs text-gray-500 dark:text-gray-500">
                                      Reason: {expense.reason} {expense.originalAmount && `• Original: ৳${expense.originalAmount.toLocaleString()}`}
                                    </p>
                                  </div>
                                  <div className="text-right">
                                    <p className="text-sm sm:text-base font-bold text-gray-900 dark:text-white">
...
export default RefundsReimbursements;
