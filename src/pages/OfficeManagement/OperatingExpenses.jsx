    ...
    if (result.isConfirmed) {
      deleteCategory.mutate(categoryId, {
        ...
        onError: (err) => {
          Swal.fire({
            title: 'ত্রুটি!',
            text: err?.response?.data?.message || 'ক্যাটাগরি মুছে ফেলতে ব্যর্থ।',
            icon: 'error',
            confirmButtonColor: '#ef4444'
          });
        }
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Helmet>
        ...
        <meta name="description" content="ব্যবসায়িক পরিচালন খরচ ব্যবস্থাপনা" />
      </Helmet>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                        <Link
                          to={`/office-management/operating-expenses/${category.id}`}
