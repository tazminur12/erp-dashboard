...
const ITSoftwareExpenses = () => {
  ...
  const subcategories = [
    {
      ...
      banglaName: 'সফটওয়্যার লাইসেন্স',
      icon: FileText,
      color: 'from-blue-500 to-blue-600'
    },
    {
      id: 'hardware-purchases',
      name: 'Hardware Purchases',
      banglaName: 'হার্ডওয়্যার ক্রয়',
      icon: Monitor,
    ...
    },
    {
      ...
      banglaName: 'নিরাপত্তা সফটওয়্যার',
      icon: Shield,
    ...
    },
    {
      ...
      banglaName: 'কম্পিউটার আনুষাঙ্গিক',
      icon: Keyboard,
  ...
  const [expenses, setExpenses] = useState([
    ...
    },
    {
      ...
      amount: 45000,
      description: 'Dell Laptops - 3 units',
      date: '2024-01-10',
      paymentMethod: 'Bank Transfer',
      reference: 'DELL-2024-003',
    ...
    },
    {
      ...
      amount: 15000,
      description: 'Norton Antivirus Business',
      date: '2024-01-05',
      paymentMethod: 'Bank Transfer',
      reference: 'NORTON-2024-005',
      vendor: 'NortonLifeLock',
      notes: 'Annual antivirus license',
      status: 'In Progress'
    }
  ]);
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-xs sm:text-sm transition-colors duration-300 ${
                  ...
                  আইটি ও সফটওয়্যার খরচ ব্যবস্থাপনা
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
          ...
          <div className={`p-3 sm:p-4 rounded-xl shadow-lg border transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Active Services</p>
                <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">
          ...
          <div className={`p-3 sm:p-4 rounded-xl shadow-lg border transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">
                  ৳{Math.round(grandTotal * 0.3).toLocaleString()}
                </p>
              </div>
        ...
        <div className={`p-3 sm:p-4 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search IT expenses..."
              value={searchTerm}
          ...
          <div className={`p-4 sm:p-6 rounded-xl shadow-lg border mb-4 sm:mb-6 transition-colors duration-300 ${
            ...
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {editItem ? 'Edit IT Expense' : 'Add New IT Expense'}
              </h3>
              <button
                onClick={() => {
                  setShowAddForm(false);
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  placeholder="IT expense description"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                      : 'border-gray-300'
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="IT vendor/provider"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' 
                      : 'border-gray-300'
              ...
              <div className="sm:col-span-2 lg:col-span-3 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg font-medium transition-all duration-200 hover:scale-105 text-sm"
                >
                    ...
                    {categoryExpenses.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                          No IT expenses found for this category
                        </p>
                      </div>
                    ) : (
...
export default ITSoftwareExpenses;
