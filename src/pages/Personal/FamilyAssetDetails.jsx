...
const FamilyAssetDetails = () => {
  ...
  const { useFamilyAsset } = useFamilyAssetQueries();

  const { data: asset, isLoading, error } = useFamilyAsset(id);
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Helmet>
        <title>{asset.name} - পারিবারিক সম্পদ বিবরণ</title>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <button
          onClick={() => navigate(`/personal/family-assets/${id}/edit`)}
